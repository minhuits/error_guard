...
var hljs = function () {
    ...
    const E = "[a-zA-Z]\\w*", x = "[a-zA-Z_]\\w*", y = "\\b\\d+(\\.\\d+)?",
      _ = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", w = "\\b(0b[01]+)", O = {
    ...
    var j = Object.freeze({
      ...
      }, BINARY_NUMBER_RE: w, COMMENT: N,
      C_BLOCK_COMMENT_MODE: M, C_LINE_COMMENT_MODE: S, C_NUMBER_MODE: {
        scope: "number",
        begin: _, relevance: 0
      }, C_NUMBER_RE: _, END_SAME_AS_BEGIN: e => Object.assign(e, {
        "on:begin": (e, t) => {
      ...
      (e => {
        ...
        if (Array.isArray(e.begin)) {
          ...
          if ("object" != typeof e.beginScope || null === e.beginScope) throw z("beginScope must be object"),
            G;
          K(e, e.begin, {key: "beginScope"}), e.begin = m(e.begin, {joinWith: ""})
        }
      })(e), (e => {
    ...
    function Z(e) {
      ...
      e.contains && e.contains.includes("self")) throw Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.")
        ;
      return e.classNameAliases = i(e.classNameAliases || {}), function n(r, o) {
        const a = r
        ;
        if (r.isCompiled) return a
          ;
        [I, B, F, D].forEach((e => e(r, o))), e.compilerExtensions.forEach((e => e(r, o))),
          r.__beforeBegin = null, [T, L, P].forEach((e => e(r, o))), r.isCompiled = !0;
        let c = null
        ;
        ...
        r.contains || (r.contains = []), r.contains = [].concat(...r.contains.map((e => (e => (e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map((t => i(e, {
          variants: null
        }, t)))), e.cachedVariants ? e.cachedVariants : V(e) ? i(e, {
    ...
    const J = n, Y = i, Q = Symbol("nomatch"), ee = n => {
      const i = Object.create(null), s = Object.create(null), r = [];
      let o = !0
      ...
      function E(e, n, s, r) {
        ...
        function l() {
          ...
          let t = N.keywordPatternRe.exec(R), n = ""
          ;
          for (; t;) {
            n += R.substring(e, t.index)
            ;const s = w.case_insensitive ? t[0].toLowerCase() : t[0], r = (i = s, N.keywords[i]);
            if (r) {
              const [e, i] = r
              ;
        ...
        function d(e, t) {
          ...
          for (; n <= i;) {
            ...
            const i = w.classNameAliases[e[n]] || e[n], s = t[n];
            i ? u(s, i) : (R = s, l(), R = ""), n++
          }
        }
        ...
        function m(e) {
          const t = e[0], i = n.substring(e.index), s = f(N, e, i);
          if (!s) return Q;
          const r = N
        ...
        let R = "", j = 0, A = 0, I = 0, T = !1;
        try {
          if (w.__emitTokens) w.__emitTokens(n, M); else {
      ...
      function y(e) {
        ...
        if (e.children.length > 0 && (p.ignoreUnescapedHTML || (console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),
          ...
          ;
        t = e;
        const i = t.textContent, r = n ? m(i, {language: n, ignoreIllegals: !0}) : x(i)
        ;e.innerHTML = r.value, e.dataset.highlighted = "yes", ((e, t, n) => {
          const i = t && s[t] || n
      ...
      Object.assign(n, {
        highlight: m, highlightAuto: x, highlightAll: w,
        highlightElement: y,
        highlightBlock: e => (X("10.7.0", "highlightBlock will be removed entirely in v12.0"),
          X("10.7.0", "Please use highlightElement now."), y(e)), configure: e => {
          p = Y(p, e)
        },
        initHighlighting: () => {
        ...
        o = !0
      }, n.versionString = "11.11.1", n.regex = {
        concat: h,
  ...
  var e = (() => {
    ...
    return e => {
      const t = e.regex, n = e.COMMENT("//", "$", {
          contains: [{begin: /\\\n/}]
        }), a = "decltype\\(auto\\)", s = "[a-zA-Z_]\\w*::",
        r = "(" + a + "|" + t.optional(s) + "[a-zA-Z_]\\w*" + t.optional("<[^<>]+>") + ")", i = {
        ...
        }, m = [c, i, n, e.C_BLOCK_COMMENT_MODE, o, l], g = {
          variants: [{begin: /=/, end: /;/}, {
            begin: /\(/, end: /\)/
          ...
          keywords: u, illegal: /[^\w\s\*&:<>.]/, contains: [{begin: a, keywords: u, relevance: 0}, {
            ...
            keywords: u, relevance: 0, contains: [n, e.C_BLOCK_COMMENT_MODE, l, o, i, {
              begin: /\(/,
      ...
      return e => {
        ...
        return {
          ...
          contains: [i, e.COMMENT(/\/\*\*(?!\/)/, /\*\//, {
            subLanguage: "markdown", relevance: 0
          }), e.COMMENT(/\/{3,} ?/, /$/, {
            contains: [{
              subLanguage: "markdown", begin: ".",
              end: "$", relevance: 0
            }]
...
(() => {
  var e = (() => {
      ...
      return e => {
        const a = e.regex, n = "[\xc0-\u02b8a-zA-Z_$][\xc0-\u02b8a-zA-Z_$0-9]*",
          i = n + t("(?:<" + n + "~~~(?:\\s*,\\s*" + n + "~~~)*>)?", /~~~/g, 2), r = {
        ...
        return {
          ...
          contains: [e.COMMENT("/\\*\\*", "\\*/", {
            ...
            begin: [a.concat(/(?!else)/, n), /\s+/, n, /\s+/, /=(?!=)/], className: {
              1: "type",
...
(() => {
  var e = (() => {
      ...
      ;const e = "[A-Za-z$_][0-9A-Za-z$_]*",
        ...
        c = ["arguments", "this", "super", "console", "window", "document", "localStorage", "sessionStorage", "module", "global"],
        i = [].concat(r, t, s)
      ;
      return o => {
...
(() => {
  var e = (() => {
      ...
      const s = e => t(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/), i = ["Protocol", "Type"].map(s),
        c = ["init", "self"].map(s), o = ["Any", "Self"],
        ...
        m = ["#colorLiteral", "#column", "#dsohandle", "#else", "#elseif", "#endif", "#error", "#file", "#fileID", "#fileLiteral", "#filePath", "#function", "#if", "#imageLiteral", "#keyPath", "#line", "#selector", "#sourceLocation", "#warning"],
        p = ["abs", "all", "any", "assert", "assertionFailure", "debugPrint", "dump", "fatalError", "getVaList", "isKnownUniquelyReferenced", "max", "min", "numericCast", "pointwiseMax", "pointwiseMin", "precondition", "preconditionFailure", "print", "readLine", "repeatElement", "sequence", "stride", "swap", "swift_unboxFromSwiftValueWithType", "transcode", "type", "unsafeBitCast", "unsafeDowncast", "withExtendedLifetime", "withUnsafeMutablePointer", "withUnsafePointer", "withVaList", "withoutActuallyEscaping", "zip"],
        d = a(/[/=\-+!*%<>&|^~?]/, /[\u00A1-\u00A7]/, /[\u00A9\u00AB]/, /[\u00AC\u00AE]/, /[\u00B0\u00B1]/, /[\u00B6\u00BB\u00BF\u00D7\u00F7]/, /[\u2016-\u2017]/, /[\u2020-\u2027]/, /[\u2030-\u203E]/, /[\u2041-\u2053]/, /[\u2055-\u205E]/, /[\u2190-\u23FF]/, /[\u2500-\u2775]/, /[\u2794-\u2BFF]/, /[\u2E00-\u2E7F]/, /[\u3001-\u3003]/, /[\u3008-\u3020]/, /[\u3030]/),
        b = a(d, /[\u0300-\u036F]/, /[\u1DC0-\u1DFF]/, /[\u20D0-\u20FF]/, /[\uFE00-\uFE0F]/, /[\uFE20-\uFE2F]/),
        F = t(d, b, "*"),
        h = a(/[a-zA-Z_]/, /[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/, /[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/, /[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/, /[\u1E00-\u1FFF]/, /[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/, /[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/, /[\u2C00-\u2DFF\u2E80-\u2FFF]/, /[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/, /[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/, /[\uFE47-\uFEFE\uFF00-\uFFFD]/),
        w = a(h, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/), f = t(h, w, "*"),
        y = t(/[A-Z]/, w, "*"),
        g = ["attached", "autoclosure", t(/convention\(/, a("swift", "block", "c"), /\)/), "discardableResult", "dynamicCallable", "dynamicMemberLookup", "escaping", "freestanding", "frozen", "GKInspectable", "IBAction", "IBDesignable", "IBInspectable", "IBOutlet", "IBSegueAction", "inlinable", "main", "nonobjc", "NSApplicationMain", "NSCopying", "NSManaged", t(/objc\(/, f, /\)/), "objc", "objcMembers", "propertyWrapper", "requires_stored_property_inits", "resultBuilder", "Sendable", "testable", "UIApplicationMain", "unchecked", "unknown", "usableFromInline", "warn_unqualified_access"],
      ...
      return e => {
        const d = {match: /\s+/, relevance: 0}, h = e.COMMENT("/\\*", "\\*/", {
          contains: ["self"]
        }), A = [e.C_LINE_COMMENT_MODE, h], E = {
          match: [/\./, a(...i, ...c)],
          className: {2: "keyword"}
        }, k = {
          match: t(/\./, a(...u)), relevance: 0
        }, C = u.filter((e => "string" == typeof e)).concat(["_|0"]), N = {
          variants: [{
            className: "keyword",
            match: a(...u.filter((e => "string" != typeof e)).concat(o).map(s), ...c)
          }]
        }, S = {
          $pattern: a(/\b\w+/, /#\w+/), keyword: C.concat(m), literal: r
        }, B = [E, k, N], D = [{
          match: t(/\./, a(...p)), relevance: 0
        }, {
          className: "built_in",
          match: t(/\b/, a(...p), /(?=\()/)
        }], _ = {match: /->/, relevance: 0}, M = [_, {
          className: "operator", relevance: 0, variants: [{match: F}, {match: `\\.(\\.|${b})+`}]
        }], x = "([0-9]_*)+", L = "([0-9a-fA-F]_*)+", $ = {
          ...
          className: "subst", match: t(/\\/, e, /[\t ]*(?:[\r\n]|\r\n)/)
        }), P = (e = "") => ({
          className: "subst", label: "interpol", begin: t(/\\/, e, /\(/), end: /\)/
        }), j = (e = "") => ({
          begin: t(e, /"""/), end: t(/"""/, e), contains: [I(e), O(e), P(e)]
          ...
          return {
            begin: n, end: a,
            contains: [...z, {scope: "comment", begin: `#(?!.*${a})`, end: /$/}]
          }
        }, Z = {
          scope: "regexp", variants: [U("###"), U("##"), U("#"), q]
        }, V = {
          match: t(/`/, f, /`/)
        }, W = [V, {className: "variable", match: /\$\d+/}, {
          className: "variable",
          match: `\\$${w}+`
        }], G = [{
          ...
          scope: "keyword", match: t(/@/, a(...g), n(a(/\(/, /\s+/)))
        }, {
          scope: "meta",
          match: t(/@/, f)
        }], H = {
          match: n(/\b[A-Z]/), relevance: 0, contains: [{
            ...
            match: /\.\.\./, relevance: 0
          }, {match: t(/\s+&\s+/, n(y)), relevance: 0}]
        }, R = {
          begin: /</, end: />/, keywords: S, contains: [...A, ...B, ...G, _, H]
        };
        H.contains.push(R)
        ;const X = {
          begin: /\(/, end: /\)/, relevance: 0, keywords: S, contains: ["self", {
            match: t(f, /\s*:/), keywords: "_|0", relevance: 0
          }, ...A, Z, ...B, ...D, ...M, $, T, ...W, ...G, H]
        }, J = {
          begin: /</, end: />/,
          keywords: "repeat each", contains: [...A, H]
        }, Q = {
          begin: /\(/, end: /\)/, keywords: S,
          contains: [{
            begin: a(n(t(f, /\s*:/)), n(t(f, /\s+/, f, /\s*:/))), end: /:/, relevance: 0,
            contains: [{className: "keyword", match: /\b_\b/}, {className: "params", match: f}]
          }, ...A, ...B, ...M, $, T, ...G, H, X], endsParent: !0, illegal: /["']/
        }, Y = {
          match: [/(func|macro)/, /\s+/, a(V.match, f, F)], className: {
            1: "keyword",
            3: "title.function"
          }, contains: [J, Q, d], illegal: [/\[/, /%/]
        }, ee = {
          match: [/\b(?:subscript|init[?!]?)/, /\s*(?=[<(])/], className: {1: "keyword"},
          contains: [J, Q, d], illegal: /\[|%/
        }, ne = {
          match: [/operator/, /\s+/, F], className: {
            1: "keyword", 3: "title"
          }
        }, te = {
          begin: [/precedencegroup/, /\s+/, y], className: {
            1: "keyword", 3: "title"
          }, contains: [H], keywords: [...l, ...r], end: /}/
        }, ae = {
          begin: [/(struct|protocol|class|extension|enum|actor)/, /\s+/, f, /\s*/],
          beginScope: {1: "keyword", 3: "title.class"}, keywords: S, contains: [J, ...B, {
            begin: /:/,
        ...
        return {
          name: "Swift", keywords: S, contains: [...A, Y, ee, {
            match: [/class\b/, /\s+/, /func\b/, /\s+/, /\b[A-Za-z_][A-Za-z0-9_]*\b/], scope: {
              1: "keyword", 3: "keyword", 5: "title.function"
            }
          }, {
  ...
  var e = (() => {
    ...
    return e => {
      const n = "true false yes no null", a = "[\\w#;/?:@&=+$,.~*'()[\\]]+", s = {
          ...
          contains: [e.BACKSLASH_ESCAPE, {
            className: "template-variable", variants: [{
              begin: /\{\{/, end: /\}\}/
            }, {begin: /%\{/, end: /\}/}]
          }]
        }, i = e.inherit(s, {
          ...
          end: ",", endsWithParent: !0, excludeEnd: !0, keywords: n,
          relevance: 0
          ...
          className: "string", relevance: 0, begin: /'/, end: /'/, contains: [{
            match: /''/,
            scope: "char.escape", relevance: 0
          }]
        }, s], g = [...r]
      ;
      return g.pop(), g.push(i), l.contains = g, {
        name: "YAML", case_insensitive: !0,
        aliases: ["yml"], contains: r
      }
    }
  })();
